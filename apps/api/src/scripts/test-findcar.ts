import { findcarSource } from '../providers/findcar/findcar.source.js';
import type { SearchCriteria } from '../providers/types.js';

/**
 * Manual smoke test for the FindCar adapter - run with:
...
const result = await findcarSource.search(criteria, { page: 1, pageSize: 40 });
