import { autoplacSource } from '../providers/autoplac/autoplac.source.js';
import type { SearchCriteria } from '../providers/types.js';

/**
 * Manual smoke test for the autoplac.pl adapter - run with:
...
const result = await autoplacSource.search(criteria, { page: 1, pageSize: 40 });
