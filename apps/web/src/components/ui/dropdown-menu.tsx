...
function DropdownMenuItem({
  ...
  inset?: boolean
  /** Not part of upstream neobrutalism - kept so existing call sites don't need a rewrite. */
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "relative gap-2 [&_svg]:pointer-events-none [&_svg]:w-4 [&_svg]:h-4 [&_svg]:shrink-0 flex cursor-default select-none items-center rounded-base border-2 border-transparent data-[inset=true]:pl-8 bg-main px-2 py-1.5 text-sm font-base outline-hidden transition-colors focus:border-border data-disabled:pointer-events-none data-disabled:opacity-50 data-[variant=destructive]:bg-destructive data-[variant=destructive]:text-destructive-foreground",
        className,
      )}
      {...props}
    />
